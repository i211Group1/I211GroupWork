...
--
-- Host: localhost
-- Generation Time: Nov 17, 2022 at 01:32 AM
...
INSERT INTO `inventory_games` (`game_id`, `game_name`, `genre_id`, `publisher_id`, `description`, `price`, `image`) VALUES
(1, 'Monopoly', 1, 1, 'Buy, sell, dream, and scheme the way to riches with the Monopoly board game! ', 19.99, 'https://cdn.shopify.com/s/files/1/0169/6995/7440/products/C10090002_630509512638_main_20_Online_2000SQ_1024x1024.jpg?v=1650894210'),
(2, 'Clue', 2, 1, 'The mystery you love to solve again and again is even more intense! ', 11.99, 'https://i5.walmartimages.com/asr/d5449a01-b3a9-40c4-8bad-17a116d1043e_1.71becdfe4cc9920db3b1a2610a267301.jpeg'),
(3, 'Risk', 1, 1, 'Take over the world in this game of strategy conquest, now with updated figures and improved Mission cards.', 33.99, 'https://www.hasbro.com/common/productimages/en_US/2C7C6F5250569047F5DDEB8AC273BA4C/1B45E578B86B4A0FAB6E88D8D82C7FDF.jpg'),
(4, 'Mystery of the Abbey', 2, 2, 'Mystery of the Abbey is a new kind of \"whodunit\" game of deduction and intuition, set in a medieval abbey. Players compete and collaborate to solve the mystery', 85, 'https://cf.geekdo-images.com/OAZmWQ4u4Sda-3lUyMVxQw__opengraph/img/Jr-WK_GRGtABLaz_KJjDjr88krc=/fit-in/1200x630/filters:strip_icc()/pic897161.jpg'),
(5, 'The Worst Case Scenario', 3, 3, 'How do you compare living through a pandemic to being chased by a gorilla or locked in the trunk of a moving car or losing your memory or being lost at sea? ', 19.99, 'https://target.scene7.com/is/image/Target/GUEST_03d8f4e2-1645-4995-be96-b00f84506c04?wid=488&hei=488&fmt=pjpeg'),
(6, 'Ticket to Ride', 4, 2, 'Ticket to Ride is a cross-country train adventure in which players collect and play matching train cards to claim railway routes connecting cities throughout North America.', 39.97, 'https://m.media-amazon.com/images/I/91YNJM4oyhL.jpg'),
(7, 'Settlers of Catan', 5, 5, 'Players take on the roles of settlers, each attempting to build and develop holdings while trading and acquiring resources. Players gain victory points as their settlements grow.', 28.99, 'https://www.catan.com/sites/default/files/2021-06/dye_catan_150407_0564.jpg'),
(8, 'Magic the Gathering', 1, 4, 'A player in Magic takes the role of a Planeswalker, a powerful wizard who can travel (\"walk\") between dimensions (\"planes\") of the Multiverse, doing battle with other players as Planeswalkers ', 49.99, 'https://media.gamestop.com/i/gamestop/11208572/Magic-The-Gathering-Arena-Starter-Kit-2022-');
